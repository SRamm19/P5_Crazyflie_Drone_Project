...
class ControlParameters:
    ...
    def __init__(self, statevector):
        ...
        self.Param_x   = PID_Parameters(   3.0,   1.0,     4.0) 
        self.Param_y   = PID_Parameters(   3.0,   1.0,     4.0)
    ...
    def _getTrajectory(self, statevector):
        ...
        return eng.GetTrajectoryxyz(matlab.double(start_point),matlab.double(via_points),matlab.double(end_point),self.Hz)
...
def PID_Controller(_current_Position, _desired_Position, _PID_Param):
    ...
    SetPoint = _desired_Position

    error = SetPoint - _current_Position
